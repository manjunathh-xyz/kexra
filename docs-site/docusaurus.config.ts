...
const config: Config = {
  title: 'Kexra',
  tagline: 'A deterministic programming language',
  ...
  url: 'https://manjunathh-xyz.github.io',
  ...
  themeConfig: {
    ...
    footer: {
          ...
          items: [
            {
              ...
              to: '/docs/getting-started/what-is-kexra',
            },
          ],
        },
        {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Kexra. Built with Docusaurus.`,
    },
    prism: {
